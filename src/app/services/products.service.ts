...
export class ProductsService {
  private products: Product[] = [
    // Bolsas y Carteras de Mano
    {
      ...
      description: 'Tenemos las bolsas y carteras que estás buscando. Descubre nuestra selección de bolsas y carteras. Encuentra las mejores bolsas y carteras en nuestra colección. Tu estilo, nuestra colección de bolsas y carteras.',
      specifications: [
    ...
    // Artículos de Papelería
    {
      ...
      description: 'Lápices, bolígrafos y artículos de escritura. Lápices con mina de grafito, lápices de colores y pinturas. Papel, tarjetas, blocs, libros e impresos. Sobres y bolsas. Material de correo y embalaje. Carpetas, cubiertas de informes e índices. Carpetas, archivadores. Pegamentos y cintas adhesivas.',
      specifications: [
    ...
    // Textiles - Calzado
    {
      ...
      description: 'Tenemos una gran variedad de productos textiles para cubrir cada área del mercado. Contamos con productos de corte y forro para dama y caballero. Todo nuestro material para calzado.',
      specifications: [
    ...
    // Textiles - Tapicería
    {
      ...
      description: 'Contamos con gran variedad de cheniles, suedes, lonas, sintéticos, viniles, material para exteriores, terciopelos y jaquards. Todos nuestros materiales pueden personalizarse con diferentes opciones de grabados, colores y recubrimientos.',
      specifications: [
        'Cheniles',
        'Suedes',
        'Lonas',
